...
$_['text_trial']                        = '%s la fiecare %s %s pentru %s plați atunci ';
...
$_['text_squareup_profile_suspended']   = ' Plățile recurente au fost suspendate. Te rugăm să ne contactezi pentru mai multe detalii.';
$_['text_squareup_trial_expired']       = ' Your trial period has expired.';
$_['text_squareup_recurring_expired']   = ' Plățile tale recurente au expirat. Aceasta a fost ultima ta plată.';
...
$_['text_token_revoked_message']        = "Accesul extensiei de plată Square la contul tău Square a fost revocat din Square Dashboard. Trebuie să verificați acreditările aplicației în setările extensiei și să vă conectați din nou.";
...
$_['error_card_invalid']                = 'Eroare: Cardul este incorect!';
